...
const clientSheetQuickActionsObserver = new MutationObserver(() => {
  document.querySelectorAll(".client-sheet-tools").forEach((tools) => {
    ...
    quick.innerHTML = `<small class="client-sheet-action-label">Criar neste cliente</small><button class="compact-action" data-client-create="projeto" type="button">+ Projeto</button><button class="compact-action" data-client-create="proposta" type="button">+ Proposta</button><button class="compact-action" data-client-create="contrato" type="button">+ Contrato</button><button class="compact-action" data-client-create="recebivel" type="button">+ Cobrança</button><button class="compact-action" data-client-create="assinatura" type="button">+ Recorrência</button><button class="compact-action" data-client-create="tarefa" type="button">+ Tarefa</button><button class="compact-action" data-client-create="ticket" type="button">+ Suporte</button>`;
    const moduleByKind = { projeto: "projetos", proposta: "propostas", contrato: "contratos", recebivel: "contas-a-receber", assinatura: "assinaturas", tarefa: "tarefas", ticket: "tickets" };
