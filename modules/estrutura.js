...
const configs = {
  ...
  form: { title: "Novo formulário", endpoint: "/api/forms", fields: [{ name: "name", label: "Nome" }, { name: "kind", label: "Tipo" }, { name: "schema", label: "Campos JSON", required: false }, { name: "automation_config", label: "Automação JSON (lead, opportunity, ticket ou task)", placeholder: '{"create":"lead"}', required: false }] },
