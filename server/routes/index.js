...
const domains = [inbox, notifications, vault, portalNotificationHooks, crm, contas, operacao, financeiro, catalogo, automacoes, configuracoes, meu_dia, whatsapp, email, teamAccess];
