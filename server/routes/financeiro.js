/* Rotas HTTP do domínio "financeiro" — Visão financeira, Receitas, Contas a receber, Despesas, Cobranças, Assinaturas, Relatórios
   Ownership: server/routes/financeiro.js (+ server/migrations/NNN_financeiro_*.sql)
