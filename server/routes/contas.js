...
export function register(app, ctx) {
  ...
  app.get("/api/clients/:id/overview", async (req, res) => {
    ...
    try {
      ...
      const [contacts, conversations, contracts, proposals, receivables, payments, revenues, projects, tasks, tickets, files, briefings, changeRequests, infrastructure, activities, financialSummary] = await Promise.all([
