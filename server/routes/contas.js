/* Rotas HTTP do domínio "contas" — Contatos, Consulta CNPJ, Clientes, Portal do cliente, Empresas
   Ownership: server/routes/contas.js (+ server/migrations/NNN_contas_*.sql)
