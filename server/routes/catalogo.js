const FIELDS = ["name", "kind", "price", "unit", "description", "active", "sku", "short_description", "long_description", "category", "image_url", "tags", "archived", "public_visible", "highlighted", "term_days", "features", "limits", "recurrence", "benefits", "delivery_time", "included_scope", "excluded_scope", "deliverables", "pages_or_modules", "revisions_included", "guarantee_period", "support_included", "client_responsibilities", "technical_requirements", "internal_notes", "min_price", "promotional_price", "internal_cost", "billing_type", "entry_value", "max_installments", "max_discount", "sales_commission", "estimated_taxes"];
