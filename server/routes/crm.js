/* Rotas HTTP do domínio "crm" — CRM comercial, Leads, Campanhas, Funil, Oportunidades, Propostas, Follow-ups
   Ownership: server/routes/crm.js (+ server/migrations/NNN_crm_*.sql)
