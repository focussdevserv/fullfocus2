/* Rotas HTTP do domínio "configuracoes" — Equipe, Configurações do workspace e do perfil
   Ownership: server/routes/configuracoes.js (+ server/migrations/NNN_configuracoes_*.sql)
