...
async function refreshHomePanels() {
  try {
    ...
    const notificationButton = document.querySelector(".notification-button"); if (notificationButton) { notificationButton.title = notifications.length ? notifications.join("\n") : "Nenhuma notificação"; notificationButton.classList.toggle("has-notifications", notifications.length > 0); }
