...
const createConfig = {
  tarefa: { title: "Nova tarefa", endpoint: "/api/tasks", fields: [{ name: "title", label: "Título", placeholder: "Ex.: Revisar briefing do cliente" }, { name: "dueAt", label: "Prazo (opcional)", type: "datetime-local", placeholder: "", required: false }] },
